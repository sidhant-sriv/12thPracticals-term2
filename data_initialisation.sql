...
DELETE FROM Coach;
INSERT INTO Coach
 VALUES (1, "Karan", 34, "Karate", 1996-03-7, 1000 "M"),
...
DELETE FROM Worker;
INSERT INTO Worker
 VALUES (11, "RadheShyam", "Supervisior","P001", "23-Aug-1981"),
        (12, "ChanderNath", "Operator","P003", "12-Jul-1987"),
        (13, "Fizza", "Operator", "P003", "14-Oct-1983"),
        (15, "Ammen Ahmed",  "Mechanic", "P002", "13-Mar-1984"),
        (18, "Sanya", "Clerk", "P002", "09-Jun-1983");
...
INSERT INTO Sports_Master 
 VALUES ("100 mts run",  1001,   1,   2001-01-1,  "Junior"),
        ("Volley ball",  1002,  9,  2001-01-2, "Senior"),
        ("Cricket", 1003, 11, 2001-01-12, "Senior"),
        ("Shot put", 1004, 1, 2001-1-13, "Junior"),
        ("Javalin", 1005, 1, 2-1-2001 2001-01-2, "Senior");
...
DELETE FROM Items;
INSERT INTO Items
 VALUES (1, "Computer",  60000,  9, 1996-5-21 ),
        (2, "Printer", 15000, 3, 1997-5-21),
        (3, "Scanner", 18000, 1, 1998-8-29),
